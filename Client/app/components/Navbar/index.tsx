        ...
        <div className="flex justify-between items-center w-full mb-7">
            ...
            <div className="flex justify-between items-center gap-5">
                ...
                <div className="relative">
                    <input type="search" placeholder="Start to search groups & products" 
            ...
            <div className="flex justify-between items-center gap-5">
                <div className="hidden md:flex justify-between items-center gap-5">
                    ...
                    <div className="relative">
                        <Bell className="cursor-pointer text-gray-500" size={16} />
                        <span className="absolute -top-2 w-4 h-4 -right-2 inline-flex items-center justify-center px-[0.4rem] py-1 text-xs 
                    ...
                    <div className="flex items-center gap-3 cursor-pointer">
                        ...
                        <span className="font-semibold">Ramy Rxr</span>
                    </div>
